...
func (g Grid) Walk(coord Coord) Lot {
	...
	up := g.Walk(Coord{X: coord.X + dir[0][0], Y: coord.Y + dir[0][1], Val: coord.Val})
	right := g.Walk(Coord{X: coord.X + dir[1][0], Y: coord.Y + dir[1][1], Val: coord.Val})
	down := g.Walk(Coord{X: coord.X + dir[2][0], Y: coord.Y + dir[2][1], Val: coord.Val})
	left := g.Walk(Coord{X: coord.X + dir[3][0], Y: coord.Y + dir[3][1], Val: coord.Val})
	return Lot{
